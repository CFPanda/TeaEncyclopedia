...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    _isGuide = [[[NSUserDefaults standardUserDefaults]valueForKey:@"isGuide"] boolValue];
    ...
    if (_isGuide) {
        ...
        DCFGuideViewController *dcfGuideVc = [[DCFGuideViewController alloc]init];
        _window.rootViewController = dcfGuideVc;
        NSUserDefaults *defauts = [NSUserDefaults standardUserDefaults];
        [defauts setValue:@YES forKey:@"isGuide"];
    }
